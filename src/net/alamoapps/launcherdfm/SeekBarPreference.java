  ...
  implements SeekBar.OnSeekBarChangeListener
{
  ...
  private String getAttributeStringValue(AttributeSet paramAttributeSet, String paramString1, String paramString2, String paramString3)
  {
  ...
  private void initPreference(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    this.mMaxValue = paramAttributeSet.getAttributeIntValue("http://schemas.android.com/apk/res/android", "max", 100);
    this.mMinValue = paramAttributeSet.getAttributeIntValue("http://robobunny.com", "min", 0);
    this.mUnitsLeft = getAttributeStringValue(paramAttributeSet, "http://robobunny.com", "unitsLeft", "");
    this.mUnitsRight = getAttributeStringValue(paramAttributeSet, "http://robobunny.com", "unitsRight", getAttributeStringValue(paramAttributeSet, "http://robobunny.com", "units", ""));
    try
    {
  ...
  public void onBindView(View paramView)
  {
    ...
    try
    {
      ...
      ViewGroup localViewGroup = (ViewGroup)paramView.findViewById(2131427353);
    ...
    {
      while (true)
        Log.e(this.TAG, "Error binding view: " + localException.toString());
    }
  }
  ...
  protected View onCreateView(ViewGroup paramViewGroup)
  {
    ...
    try
    {
      localRelativeLayout = (RelativeLayout)((LayoutInflater)getContext().getSystemService("layout_inflater")).inflate(2130903049, paramViewGroup, false);
    ...
    {
      while (true)
        Log.e(this.TAG, "Error creating seek bar preference", localException);
    }
  }
 ...
 * Qualified Name:     net.alamoapps.launcherdfm.SeekBarPreference
