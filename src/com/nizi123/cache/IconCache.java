...
import com.nizi123.entity.ApplicationInfo;
import com.nizi123.utils.Utilities;
...
public class IconCache {
    ...
    public IconCache(Context context) {
        ...
        mIconDpi = activityManager.getLauncherLargeIconDensity();//获得首�?的图标大小的密度
    ...
    /**
     * 从intent中获得程序图�?如果无法获得component则返回默认图�?
     * @param intent
     * @return
     */
    ...
    /**
     * 通过Component,resolveinfo，标签缓存获得图�?
     * @param component
     * @param resolveInfo
     * @param labelCache
     * @return
